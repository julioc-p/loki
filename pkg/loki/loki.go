...
type Config struct {
	...
	RateService         rateservice.Config         `yaml:"rateservice,omitempty" category:"experimental"`
	RateServiceClient   rateservice_client.Config  `yaml:"rateservice_client,omitempty" category:"experimental"`
...
func (c *Config) Validate() error {
	...
	if err := c.RateService.Validate(); err != nil {
		errs = append(errs, errors.Wrap(err, "CONFIG ERROR: invalid rateservice config"))
	}
